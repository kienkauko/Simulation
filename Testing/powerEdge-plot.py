...
data1 = np.loadtxt('totalEdgePowerSystem.txt', usecols=[0])
y1 = data1
datax2 = np.loadtxt('totalChainAcceptDP.txt', usecols=[0])
datay2 = np.loadtxt('totalEdgePowerSystemDP.txt', usecols=[0])

xGR = np.loadtxt('totalChainAcceptGR.txt', usecols=[0])
yGR = np.loadtxt('totalEdgePowerSystemGR.txt', usecols=[0])

plt.plot(x1, y1, color = 'r', label = "Proposed algorithm")
plt.plot(datax2, datay2, color = 'k', label = "DP algorithm")
